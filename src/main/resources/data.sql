...
INSERT INTO public."USERS"("username", "email", "password")
VALUES ('myUser', 'myUser@gmail.com', '$2a$10$IWh0iCO.NuUWSAcXqQFuC.yHSBKZYyhWUWk3vJvs5m11iWtvkPvs6');

INSERT INTO public."AUTHORITIES" ("username", "authority") values ('myUser','ROLE_USER');
